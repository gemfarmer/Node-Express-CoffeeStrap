...
(function() {
  var DB, app, config, db, express, moment, mongo, mongoStore, mongoose, passport, port, routes, storeConf, _ref;
  ...
  db = new DB.startup((_ref = process.env.MONGOHQ_URL) != null ? _ref : 'mongodb://localhost/' + config.dbname);
